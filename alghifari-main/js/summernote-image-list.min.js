    ...
    imageList: function (context) {
      ...
      this.createDialog = function (container) {
        var dialogOption = {
          ...
          footer: ['<button type="button" class="btn btn-default image-list-btn-close">Close</button>'].join(''),
          closeOnEscape: !0,
        };
          ...
          ui.onDialogShown(self.$dialog, function () {
            ...
            $.get(imageListOptions.endpoint, null, null, 'json').done(function (data) {
              ...
              self.$dialog.find('.image-list-item').click(function (event) {
                deferred.resolve({ filename: $(this).children('img').data('filename'), fullUrl: $(this).children('img').data('full-url') });
              });
            });
