...
<p>
    <a href="partners_input.php">
        <input type="button" class="btn btn-primary" value="Buat Data Partners Baru" />
    </a>
</p>
<?php
if ($sukses) {
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="partners.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Hapus data?')">
